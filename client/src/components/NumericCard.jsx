    ...
    const data = [
        {
            ...
            change: `${getDifferenceInPercentage(totalTurnOver?.prevValue || 0, totalTurnOver?.currentValue || 0).toLocaleString()}%`,
        ...
        },
        {
            ...
            change: `${getDifferenceInPercentage(profit?.prevValue || 0, profit?.currentValue || 0).toLocaleString()}%`,
            trend: (totalTurnOver?.prevValue < totalTurnOver?.currentValue) ? UP_TREND_ICON : DOWN_TREND_ICON
        },
        {
            name: "New Customers",
            ...
            change: `${getDifferenceInPercentage(newCustomers?.prevValue || 0, newCustomers?.currentValue || 0).toLocaleString()}%`,
            trend: (totalTurnOver?.prevValue < totalTurnOver?.currentValue) ? UP_TREND_ICON : DOWN_TREND_ICON
        },
        {
            ...
            change: `${getDifferenceInPercentage(topCustomers?.prevValue || 0, topCustomers?.currentValue || 0).toLocaleString()}%`,
        ...
        },
        {
            ...
            change: `${getDifferenceInPercentage(loss?.prevValue || 0, loss?.currentValue || 0).toLocaleString()}%`,
