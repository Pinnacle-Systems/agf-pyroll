...
import { useGetCapPlanDataQuery, useGetFabStsDataQuery, useGetProfitLossDataQuery } from '../../redux/service/orderManagement'
    ...
    return (
        <div className='h-full w-full overflow-auto px-1 mb-[100px]'>
            ...
            <div className='grid grid-cols-2 h-[100%]
                '><div><CardWrapper name={'Profit & Loss'}><NegativeChart plData={plData} /></CardWrapper></div>
                <div className='h-full'><CardWrapper name={'Country Wise Orders'}><CapacityPlanner capPlanData={capPlanData} /></CardWrapper></div>
                <div><CardWrapper name={'Live Shipments'}><GoogleGaugeChart
                /></CardWrapper></div>
            </div>
        </div>
    )
